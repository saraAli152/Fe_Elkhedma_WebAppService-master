    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ModelState.AddModelError("", "تسجيل الدخول غير صحيح.");
                    return View(model);
            }
        }
        ...
        {
            ViewBag.UserType = new SelectList(db.Roles.Where(ww=> !ww.Name.Contains("Admin")).ToList(),"Name","Name");
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            {
                //ViewBag.UserType = new SelectList(db.Roles.Where(ww => !ww.Name.Contains("Admin")).ToList(), "Name", "Name");
                //ViewBag.UserType = new SelectList(new[] { "مقدم خدمة", "مقدم خدمةة" });
